...
using namespace cv;
bool photo = true;
Point2f srcTri[4], dstTri[4], ret[4];
Mat image;
int imageHeight;
int imageWidth;
...
//    Mat frame = imread("4.png");
    image = imread("1010.jpg");
    imshow("frame", image);

//    resize(frame, frame, Size(640, 480));
    int n = 4;
    polylines(image, reinterpret_cast<const Point *const *>(ret), &n, 1, true, Scalar(0, 255, 0), 3,
              LINE_AA);
